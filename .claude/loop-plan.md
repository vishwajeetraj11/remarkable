...
- [x] 2.3 — breadcrumbs (SSR BreadcrumbList JSON-LD + visible nav, all 5 sections incl. packs), label? added to site-map, debugger clean + reviewer P1 (packs) fixed
