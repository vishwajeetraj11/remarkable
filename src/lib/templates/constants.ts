export const DEVICES = {
  ...
  paperProMove: { w: 336.67, h: 598.52, label: "Paper Pro Move (954×1696)" },
  paperPure: { w: 495.72, h: 661.68, label: "Paper Pure (1404×1872)" },
  supernote: { w: 495.72, h: 661.68, label: "Supernote A5X (1404×1872)" },
  supernoteManta: { w: 677.65, h: 903.53, label: "Supernote Manta (1920×2560)" },
  booxNote: { w: 495.72, h: 661.68, label: "BOOX Note Air (1404×1872)" },
  booxTab: { w: 495.72, h: 661.68, label: "BOOX Tab Ultra (1404×1872)" },
